...
export default function Navigation() {
  ...
  return (
    <nav className="fixed left-0 top-0 z-40 hidden min-h-16 w-full justify-center bg-white/30 backdrop-blur-sm supports-[backdrop-filter]:bg-secondary/80 lg:flex lg:items-center">
      <ul
